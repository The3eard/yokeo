...
ALTER TABLE
  `objetousuario`
MODIFY
  `idObjetoUsuario` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
  `lugarvotado`
ADD
  CONSTRAINT `lugarvotado_ibfk_1` FOREIGN KEY (`idLugarVotado`) REFERENCES `lugarpropuesto` (`idLugar`),
ADD
  CONSTRAINT `lugarvotado_ibfk_2` FOREIGN KEY (`emailUsuario`) REFERENCES `usuario` (`email`);
...
ALTER TABLE
  `objetousuario`
ADD
  CONSTRAINT `objetousuario_ibfk_1` FOREIGN KEY (`idObjetoUsuario`) REFERENCES `objetopropuesto` (`idObjeto`),
ADD
  CONSTRAINT `objetousuario_ibfk_2` FOREIGN KEY (`emailUsuario`) REFERENCES `usuario` (`email`);
